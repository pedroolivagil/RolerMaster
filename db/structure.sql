DROP TABLE `character_game`, `character_user`, `country_trans`, `game_resource`, `gender_trans`, `locale_trans`, `parameter`, `preference`, `user_game`, `user_roler`;
DROP TABLE `character`, `game`, `game_category`, `resource`, `user`;
DROP TABLE `country`, `gender`, `locale`;
...
CREATE TABLE country (
  idCountry INT(10) UNSIGNED PRIMARY KEY,
...
CREATE TABLE country_trans (
  idTrans   INT(10) UNSIGNED PRIMARY KEY,
  idCountry INT(10) UNSIGNED,
  idLocale  INT(10) UNSIGNED,
...
CREATE TABLE locale (
  idLocale INT(10) UNSIGNED PRIMARY KEY,
...
CREATE TABLE resource (
  idResource INT(10) UNSIGNED PRIMARY KEY,
...
CREATE TABLE preference (
  idPrefs INT(10) UNSIGNED PRIMARY KEY,
  idUser  INT(10) UNSIGNED,
...
CREATE TABLE game_category (
  idCategory INT(10) UNSIGNED PRIMARY KEY,
  idUser     INT(10) UNSIGNED,
...
CREATE TABLE gender (
  idGender INT(10) UNSIGNED PRIMARY KEY,
  code     VARCHAR(3) NOT NULL
);
...
CREATE TABLE parameter (
  idParameter INT(10) UNSIGNED PRIMARY KEY,
...
CREATE TABLE game (
  idGame         INT(10) UNSIGNED PRIMARY KEY,
...
CREATE TABLE `character` (
  idCharacter INT(10) UNSIGNED PRIMARY KEY,
